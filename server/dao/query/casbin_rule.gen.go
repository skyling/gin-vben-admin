...
type ICasbinRuleDo interface {
	...
	GetByID(id int64) (result *models.CasbinRule, err error)
	GetByIds(ids []int64) (result []*models.CasbinRule, err error)
}

// SELECT * FROM @@table WHERE id=@id
func (c casbinRuleDo) GetByID(id int64) (result *models.CasbinRule, err error) {
...
func (c casbinRuleDo) GetByIds(ids []int64) (result []*models.CasbinRule, err error) {
	var params []interface{}
