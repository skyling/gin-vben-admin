...
type IUserRoleDo interface {
	...
	GetByID(id int64) (result *models.UserRole, err error)
	GetByIds(ids []int64) (result []*models.UserRole, err error)
}

// SELECT * FROM @@table WHERE id=@id
func (u userRoleDo) GetByID(id int64) (result *models.UserRole, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM user_roles WHERE id=? ")
...
func (u userRoleDo) GetByIds(ids []int64) (result []*models.UserRole, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, ids)
	generateSQL.WriteString("SELECT * FROM user_roles WHERE id in (?) ")
