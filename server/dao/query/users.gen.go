...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Extend = field.NewField(tableName, "extend")
	_user.Status = field.NewInt64(tableName, "status")
	_user.Dept = userBelongsToDept{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Dept", "models.Dept"),
		Depts: struct {
			field.RelationField
		}{
			RelationField: field.NewRelation("Dept.Depts", "models.Dept"),
		},
	}
	...
	_user.Roles = userManyToManyRoles{
		...
		Permissions: struct {
			...
			Permissions: struct {
				...
				RelationField: field.NewRelation("Roles.Permissions.Permissions", "models.Permission"),
			},
			Roles: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Roles.Permissions.Roles", "models.Role"),
			},
		},
		Users: struct {
			field.RelationField
			...
			RelationField: field.NewRelation("Roles.Users", "models.User"),
			Dept: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Roles.Users.Dept", "models.Dept"),
			},
			Roles: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Roles.Users.Roles", "models.Role"),
			},
		},
	}
...
func (u *user) updateTableName(table string) *user {
	...
	u.Extend = field.NewField(table, "extend")
...
func (a userBelongsToDept) Where(conds ...field.Expr) *userBelongsToDept {
	if len(conds) == 0 {
		return &a
	}
...
func (a userBelongsToDept) WithContext(ctx context.Context) *userBelongsToDept {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a userBelongsToDept) Session(session *gorm.Session) *userBelongsToDept {
	a.db = a.db.Session(session)
	return &a
}

func (a userBelongsToDept) Model(m *models.User) *userBelongsToDeptTx {
	return &userBelongsToDeptTx{a.db.Model(m).Association(a.Name())}
}

type userBelongsToDeptTx struct{ tx *gorm.Association }

func (a userBelongsToDeptTx) Find() (result *models.Dept, err error) {
	return result, a.tx.Find(&result)
}

func (a userBelongsToDeptTx) Append(values ...*models.Dept) (err error) {
...
func (a userBelongsToDeptTx) Replace(values ...*models.Dept) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userBelongsToDeptTx) Delete(values ...*models.Dept) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userBelongsToDeptTx) Clear() error {
	return a.tx.Clear()
}

func (a userBelongsToDeptTx) Count() int64 {
	return a.tx.Count()
}
...
type IUserDo interface {
	...
	GetByID(id int64) (result *models.User, err error)
	GetByIds(ids []int64) (result []*models.User, err error)
	GetByIDAndTID(tid int64, id int64) (result *models.User, err error)
	GetByIdsAndTID(tid int64, ids []int64) (result []*models.User, err error)
}

// SELECT * FROM @@table WHERE id=@id
func (u userDo) GetByID(id int64) (result *models.User, err error) {
...
func (u userDo) GetByIds(ids []int64) (result []*models.User, err error) {
	var params []interface{}
...
func (u userDo) GetByIDAndTID(tid int64, id int64) (result *models.User, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	params = append(params, tid)
	generateSQL.WriteString("SELECT * FROM users WHERE id=? and tenant_id=? ")
...
func (u userDo) GetByIdsAndTID(tid int64, ids []int64) (result []*models.User, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, ids)
	params = append(params, tid)
	generateSQL.WriteString("SELECT * FROM users WHERE id in (?) and tenant_id=? ")
